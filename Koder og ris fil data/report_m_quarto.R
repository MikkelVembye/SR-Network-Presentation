...
#' report using RMarkdown. The report can be saved in formats as HTML, PDF, Word, or more. The generated 
...
#'
#' @usage report( data = dis_res$answer_data_aggregated,
#' studyid = studyid, title = title, abstract = abstract,
#' gpt_answer = longest_answer, file = "StudyReport_AIscreenR_test1.qmd",
#' format = "docx", document_title = "Study Report - Disagreement Explanations")
#'
...
# Load data
dis_res <- readRDS("c:/Users/B375477/Desktop/Thomas_aiscreenr/disagreement_description_res_obj_4o-mini_10repsTEST.rds")
# Print the data
dis_res$answer_data_aggregated

# Print columns in the data
names(dis_res$answer_data_aggregated)

dis_res$answer_data_aggregated |>
  dplyr::select(author, abstract, final_decision_gpt, longest_answer, human_code, final_decision_gpt_num)
...
report(
  ...
  file = "StudyReport_AIscreenR_test1.qmd",
  format = "pdf",
